...
export function LEDIndicator({ color = 'green', blinking = true, size = 12 }: LEDIndicatorProps) {
  const getColor = () => {
    switch (color) {
      case 'green': return 'var(--neon-green)';
      case 'red': return 'var(--christmas-red)';
      case 'gold': return 'var(--gold)';
      case 'blue': return 'var(--cold-blue)';
