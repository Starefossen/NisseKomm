...
const colorFilters: Record<IconColor, string> = {
  green: 'brightness(0) saturate(100%) invert(75%) sepia(97%) saturate(3077%) hue-rotate(66deg) brightness(118%) contrast(128%)',
...
export const Icons = {
  ...
  FolderOpen: (props: Omit<IconProps, 'name'>) => <Icon name="folder" {...props} />,
  ...
  Signal: (props: Omit<IconProps, 'name'>) => <Icon name="cellular-signal" {...props} />,
  ...
  CheckCircle: (props: Omit<IconProps, 'name'>) => <Icon name="check" {...props} />,
  ...
  Volume: (props: Omit<IconProps, 'name'>) => <Icon name="audio-device" {...props} />,
